          ...
          <div className="bg-purple-900 relative flex flex-wrap py-5 rounded shadow-md con">
            ...
            <div className="lg:w-1/2 mt-4 lg:mt-0">
              ...
              <a className="text-white leading-relaxed sm-text-4x1">
                maged.hikal@yahoo.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed text-white">0730400085</p>
            </div>
          </div>
        </div>
        <form
          ...
          <p className="leading-relaxed mb-5 sm:mx-2">
            If you are interested in my work so please contact me by this form or send an email directly.
          </p>
          <div className="relative mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full bg-ehite-800 rounded border border-purple-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-900 text-base outline-none text-gray-900 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              id="email"
              name="email"
              className="w-full bg-white-800 rounded border border-purple-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-900 text-base outline-none text-gray-900 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
          ...
          <div className="relative mb-4">
            ...
            <textarea
              id="message"
              name="message"
              className="w-full bg-white-800 rounded border border-purple-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-900 h-32 text-base outline-none text-gray-900 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
              onChange={(e) => setMessage(e.target.value)}
            />
          </div>
          <button
            type="submit"
            className="text-white bg-purple-900 border-0 py-2 px-6 focus:outline-none hover:bg-purple-500 rounded text-lg">
            Submit
          </button>
        </form>
      </div>
